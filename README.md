...
H3: หมวด Other จะให้ประสิทธิภาพการพยากรณ์ดีกว่า Ornaments เนื่องจากข้อมูลมีสัญญาณ (signal) ชัดเจนกว่า
...
เหตุผลในการเลือกตัวแปรทางสถิติ

ปัจจัยด้านต้นทุน (Shipping) ส่งผลต่อ Demand price sensitivity

ปัจจัยด้านลูกค้า (Age, Rating) เป็นตัวแทนคุณลักษณะผู้ซื้อ

ปัจจัยด้านเวลา (Seasonality) สะท้อนความผันผวนทางตลาดตามช่วงเดือน
...
หมวด Other มีสัญญาณชัดเจนกว่า ทำให้โมเดลเรียนรู้ patterns ได้ดีกว่า

ผลลัพธ์สอดคล้องกับ hypothesis (H3)
